            ...
            <div className='bg-white p-4 mb-4' key={deal.id}>
              ...
              <div className='dofinal' style={{ flex: 8 }}>
                <div className='flex items-center text-2xs'>
                  <div id='shopname_tag' className=' text-6xs display: inline-block rounded-md bg-[color:#a4cff5] my-1 p-1 '>{deal.origin_sitename}</div>
                ...
                <a href={deal.origin_url} id='ranking_alink' className=' text-sm text-blue-50 font-semibold text-ellipsis overflow-hidden max-w-3xl mt-2 text-decoration-line:none' >
                  {deal.origin_title}
                </a>
                {deal.origin_price === 0 ? (
