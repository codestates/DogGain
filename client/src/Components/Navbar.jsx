...
function Navbar() {
  return (
    <>
      <div className=''>
        <div className="flex items-center space-x-6 text-blue-50 text-4xl font-bold ml-[10.5rem] mt-4">
        ...
        <nav className="flex items-center space-x-6 text-blue-50 mt-4 py-1 border-solid border-grey-50 border-[0.25px]">
          <ul className="hidden md:flex md:flex-row items-end space-x-2 ml-40 pl-4 ">
            <Link to="/ranking">
